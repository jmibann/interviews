...
const StarsCalification = (props) => {
  let array = ['fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star', 'fa fa-star'];
  for (let i = 0; i < props.score; i++) { array[i] = 'fa fa-star checked'; }
